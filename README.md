...
**[Search all repos](https://rsasaki0109.github.io/robotics-repo-hub/)** | 
[Browse by org](#organizations)
...
| Organization | Domain | Description | Repos | Stars | Catalog |
|---|---|---|---|---|---|
| [ETH Zurich ASL](https://github.com/ethz-asl) | SLAM & Mapping | ETH Autonomous Systems Lab — SLAM, mapping, aerial robotics | 226 | 35,620 | [View](orgs/ethz-asl.md) |
| [HKUST Aerial Robotics](https://github.com/HKUST-Aerial-Robotics) | Aerial & SLAM | HKUST — VINS-Mono/Fusion, FAST-LIO, autonomous UAV | 68 | 33,656 | [View](orgs/HKUST-Aerial-Robotics.md) |
| [HKU MARS Lab](https://github.com/hku-mars) | LiDAR SLAM | FAST-LIO, FAST-LIO2, ikd-Tree — state-of-the-art LiDAR-inertial SLAM | 49 | 32,595 | [View](orgs/hku-mars.md) |
| [ETH RSL (Legged Robotics)](https://github.com/leggedrobotics) | Legged Robots | ETH Robotic Systems Lab — ANYmal, legged locomotion, elevation mapping | 124 | 22,275 | [View](orgs/leggedrobotics.md) |
| [MIT SPARK Lab](https://github.com/MIT-SPARK) | Spatial Perception | MIT — Kimera, Hydra, spatial perception and scene understanding | 78 | 14,767 | [View](orgs/MIT-SPARK.md) |
| [Kenji Koide (AIST / SLAM)](https://github.com/koide3) | LiDAR Registration | small_gicp, ndt_omp, hdl_graph_slam, GLIM | 61 | 13,185 | [View](orgs/koide3.md) |
| [Univ. Zaragoza SLAM Lab](https://github.com/UZ-SLAMLab) | Visual SLAM | ORB-SLAM3 — state-of-the-art visual/visual-inertial SLAM | 8 | 8,806 | [View](orgs/UZ-SLAMLab.md) |
| [IntRoLab (Sherbrooke)](https://github.com/introlab) | Visual SLAM | RTAB-Map, find-object — visual SLAM and object recognition | 50 | 7,903 | [View](orgs/introlab.md) |
| [Tixiao Shan (LIO-SAM)](https://github.com/TixiaoShan) | LiDAR SLAM | LIO-SAM, LeGO-LOAM — widely-used LiDAR-inertial SLAM | 13 | 7,653 | [View](orgs/TixiaoShan.md) |
...
| Organization | Domain | Description | Repos | Stars | Catalog |
|---|---|---|---|---|---|
| [Atsushi Sakai](https://github.com/AtsushiSakai) | Robotics Education | PythonRobotics — robotics algorithms samples, 20k+ stars | 106 | 31,458 | [View](orgs/AtsushiSakai.md) |
| [Gao Xiang](https://github.com/gaoxiang12) | SLAM Education | serta slambook — Introduction to Visual SLAM, 14 lectures | 22 | 24,107 | [View](orgs/gaoxiang12.md) |
| [Raul Mur-Artal](https://github.com/raulmur) | Visual SLAM | ORB-SLAM, ORB-SLAM2 — seminal visual SLAM systems | 4 | 12,007 | [View](orgs/raulmur.md) |
| [Davide Faconti](https://github.com/facontidavide) | ROS Tools | PlotJuggler, BehaviorTree.CPP — essential ROS dev tools | 61 | 9,496 | [View](orgs/facontidavide.md) |
| [neka-nat](https://github.com/neka-nat) | 3D Vision | Open3D contributions, cupoch (GPU point cloud), 3D processing | 103 | 4,028 | [View](orgs/neka-nat.md) |
| [Engcang Choi](https://github.com/engcang) | SLAM | SLAM comparison, LiDAR-visual SLAM integration, ROS tools | 42 | 3,722 | [View](orgs/engcang.md) |
| [Steve Macenski](https://github.com/SteveMacenski) | Navigation & SLAM | Nav2 lead, slam_toolbox, opennav — ROS 2 navigation ecosystem | 40 | 3,689 | [View](orgs/SteveMacenski.md) |
| [Ryohei Sasaki](https://github.com/rsasaki0109) | Localization & GNSS | eagleye contributor, GNSS/IMU localization, lidar_localization_ros2 | 66 | 2,912 | [View](orgs/rsasaki0109.md) |
| [Hyungtae Lim (KAIST)](https://github.com/LimHyungTae) | LiDAR Perception | Patchwork, ERASOR — ground segmentation & dynamic object removal | 47 | 2,907 | [View](orgs/LimHyungTae.md) |
| [Alexey Bochkovskiy](https://github.com/AlexeyAB) | Object Detection | darknet/YOLOv4 — real-time object detection | 18 | 2,700 | [View](orgs/AlexeyAB.md) |
| [William Woodall](https://github.com/wjwwood) | ROS Core | ROS 2 core maintainer, rclcpp, serial library | 59 | 2,496 | [View](orgs/wjwwood.md) |
| [Mizuho Aoki](https://github.com/MizuhoAOKI) | Control & Planning | Vehicle dynamics, path tracking, MPC, control algorithms | 32 | 1,733 | [View](orgs/MizuhoAOKI.md) |
| [Chris Lalancette](https://github.com/clalancette) | ROS Core | ROS 2 core maintainer, launch, image_transport | 46 | 548 | [View](orgs/clalancette.md) |
| [Mathieu Labbe](https://github.com/matlabbe) | Visual SLAM | RTAB-Map — RGB-D/Stereo/LiDAR SLAM with loop closure | 3 | 135 | [View](orgs/matlabbe.md) |
