...
| [chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) | 21,207 | Python | Low | The ChatGPT Retrieval Plugin lets you easily find personal or work documents by  |
| [openai-agents-python](https://github.com/openai/openai-agents-python) | 20,582 | Python | Active | A lightweight, powerful framework for multi-agent workflows |
...
| [evals](https://github.com/openai/evals) | 18,130 | Python | Active | Evals is a framework for evaluating LLMs and LLM systems, and an open-source reg |
| [tiktoken](https://github.com/openai/tiktoken) | 17,802 | Python | Active | tiktoken is a fast BPE tokeniser for use with OpenAI's models. |
| [baselines](https://github.com/openai/baselines) | 16,685 | Python | Low | OpenAI Baselines: high-quality implementations of reinforcement learning algorit |
| [skills](https://github.com/openai/skills) | 16,179 | Python | Active | Skills Catalog for Codex |
| [symphony](https://github.com/openai/symphony) | 14,588 | Elixir | Active | Symphony turns project work into isolated, autonomous implementation runs, allow |
| [shap-e](https://github.com/openai/shap-e) | 12,229 | Python | Low | Generate 3D objects conditioned on text or images |
| [codex-plugin-cc](https://github.com/openai/codex-plugin-cc) | 11,788 | JavaScript | Active | Use Codex from Claude Code to review code or delegate tasks. |
...
| [openai-node](https://github.com/openai/openai-node) | 10,789 | TypeScript | Active | Official JavaScript / TypeScript library for the OpenAI API |
...
| [parameter-golf](https://github.com/openai/parameter-golf) | 4,641 | Python | Active | Train the smallest LM you can that fits in 16MB. Best model wins! |
| [simple-evals](https://github.com/openai/simple-evals) | 4,424 | Python | Moderate | — |
...
| [human-eval](https://github.com/openai/human-eval) | 3,188 | Python | Low | Code for the paper "Evaluating Large Language Models Trained on Code" |
| [glow](https://github.com/openai/glow) | 3,183 | Python | Low | Code for reproducing results in "Glow: Generative Flow with Invertible 1x1 Convo |
...
| [openai-go](https://github.com/openai/openai-go) | 3,115 | Go | Active | The official Go library for the OpenAI API |
...
| [openai-agents-js](https://github.com/openai/openai-agents-js) | 2,584 | TypeScript | Active | A lightweight, powerful framework for multi-agent workflows and voice agents |
...
| [openai-openapi](https://github.com/openai/openai-openapi) | 2,356 | — | Moderate | OpenAPI specification for the OpenAI API |
