...
| [jepa](https://github.com/facebookresearch/jepa) | 3,683 | Python | Low | PyTorch code and models for V-JEPA self-supervised learning from video. |
| [habitat-sim](https://github.com/facebookresearch/habitat-sim) | 3,599 | C++ | Active | A flexible, high-performance 3D simulator for Embodied AI research. |
...
| [vjepa2](https://github.com/facebookresearch/vjepa2) | 3,553 | Python | Active | PyTorch code and models for VJEPA2 self-supervised learning from video. |
| [sam-audio](https://github.com/facebookresearch/sam-audio) | 3,438 | Python | Active | The repository provides code for running inference with the Meta Segment Anythin |
...
| [perception_models](https://github.com/facebookresearch/perception_models) | 2,233 | Jupyter Notebook | Active | State-of-the-art Image & Video CLIP, Multimodal Large Language Models, and More! |
| [HyperAgents](https://github.com/facebookresearch/HyperAgents) | 2,124 | Python | Active | Self-referential self-improving agents that can optimize for any computable task |
| [fairchem](https://github.com/facebookresearch/fairchem) | 2,035 | Python | Active | FAIR Chemistry's library of machine learning methods for chemistry  |
